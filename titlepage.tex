...
%  - twocolumn: Switch to tw %>% o column for main text
...
%%% on your work.
\documentclass[$apsroptions$]{apsrsubmission}
\totalwordcount{$wordcount$}
...
\author{Jonathan Mellon}
       {University of Manchester/British Election Study}
       {Jonathan Mellon is co-director of the British Election Study and a Senior Lecturer in the Department of Politics, University of Manchester, Oxford Rd, Manchester M13 9PL, UK. Email: jonathan.mellon@manchester.ac.uk Tel: +1-213-284-0282.}
\author{Christopher Prosser}
       {Royal Holloway University/British Election Study}
       {Christopher Prosser is co-director of the British Election Study.}
       
\thanks{Thank you to Jack Bailey and Rex Douglas for their insightful comments on earlier drafts of this paper.}
...
\usepackage{graphicx}
\usepackage{rotating}
\usepackage{multirow, tabularx,array,dcolumn,placeins,booktabs,longtable,lscape,grffile,inputenc,setspace}\providecommand{\pgfsyspdfmark}[3]{}
